...
GameStartedEvent.prototype.toString = function () {
    ...
    case Hearts.PASS_LEFT: str += "Passing left: Choose 3 cards"; break;
    case Hearts.PASS_RIGHT: str += "Passing right: Choose 3 cards"; break;
    case Hearts.PASS_ACROSS: str += "Passing across: Choose 3 cards"; break;
